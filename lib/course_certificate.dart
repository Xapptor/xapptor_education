...
Future<CourseCertificate> get_certificate_from_id({
  ...
  var certificate_snap =
      await FirebaseFirestore.instance.collection("certificates").doc(id).get();

  var course_snap = await FirebaseFirestore.instance
      .collection("courses")
      .doc(certificate_snap.get("course_id"))
      .get();

  if (user_name == null) {
    var user_snap = await FirebaseFirestore.instance
        .collection("users")
        .doc(certificate_snap.get("user_id"))
        .get();
