...
Future<CourseCertificate> get_certificate_from_id({
  ...
  var certificate_snap = await XapptorDB.instance.collection("certificates").doc(id).get();

  var course_snap = await XapptorDB.instance.collection("courses").doc(certificate_snap.get("course_id")).get();
